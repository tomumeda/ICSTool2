...
$UserName=$q->param('UserName');
$FindByName=$q->param("FindByName");
$LastUserName=$q->param('LastUserName');
$LastAction=$q->param('LastAction');
$UserAction=$q->param('UserAction');
...
#  print "@assignmentOptions <br>";
#  print "==1<br>@teamAssignmentOptions";
#  print "<br>==2<br>@formTeamAuthority";
#  print "<br>==3<br>@assignAllAuthority";
#  print "<br>==44 $canFormTeam,$canAssignAll==";
}
